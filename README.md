...
Для формирования сообщений используйте `cz commit` – инструмент задаст вопросы и
создаст commit в формате Conventional Commits. В дальнейшем история
коммитов будет анализироваться `semantic-release` для автоматического
